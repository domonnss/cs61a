...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        "*** YOUR CODE HERE ***"
        currnet_frame = self
        while currnet_frame is not None:
            if symbol in currnet_frame.bindings:
                return currnet_frame.bindings[symbol]
            else:
                currnet_frame = currnet_frame.parent
    ...
    def make_child_frame(self, formals, vals):
        ...
        current_formal, current_val = formals, vals
        while current_formal is not nil and current_val is not nil:
            child_frame.define(current_formal.first, current_val.first)
